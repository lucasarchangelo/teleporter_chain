...
module.exports = {
  ...
  networks: {
    ...
    avalanche: {
      provider: () => new HDWalletProvider(mnemonic, `https://avalanche.public-rpc.com`),
      network_id: 56,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    arbitrum_goerli: {
      provider: () => new HDWalletProvider(mnemonic, `https://rpc.goerli.arbitrum.gateway.fm`),
      network_id: 56,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    arbitrum: {
      provider: () => new HDWalletProvider(mnemonic, `https://arb1.croswap.com/rpc`),
      network_id: 56,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    optimism_goerli: {
      provider: () => new HDWalletProvider(mnemonic, `https://optimism-goerli.blockpi.network/v1/rpc/public`),
      network_id: 56,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
